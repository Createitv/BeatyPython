...
class Water():
    ...
    def setTemperature(self, temperature):
        ...
        if (self.__temperature <= 0):
            ...
            self.changeState(SolidState("液态"))
        else:
            self.changeState(SolidState("气态"))
...
class SolidState(State):
    ...
    def behavior(self, water):
        print("固态——当前体温:", str(water.getTemperature()))


class LiqidState(State):
    """液态"""
    ...
    def behavior(self, water):
        print("液态——当前体温:", str(water.getTemperature()))
...
class GaseousState(State):
    ...
    def behavior(self, water):
        print("气态——当前体温:", str(water.getTemperature()))


def testState():
    water = Water(LiqidState("液态"))
    water.behavior()
